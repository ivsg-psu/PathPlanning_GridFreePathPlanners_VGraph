...
%       script_demo_VisibilityGraph.m
% This is a script to demonstrate the functions within the VGraph code
% library. This code repo is typically located at:
%   https://github.com/ivsg-psu/PathPlanning_GridFreePathPlanners_VisibilityGraph
%
...
%% fcn_Visibility_plotVGraph - showing full graph
% Plots the visilibity graph for a field of polytopes

% This is DEMO case 10002 in the test script
figNum = 10001;
titleString = sprintf('fcn_Visibility_plotVGraph - showing full graph');
...
%% fcn_Visibility_plotVGraph - showing selected from index
...
figNum = 10002;
titleString = sprintf('fcn_Visibility_plotVGraph - showing selected from index');
fprintf(1,'Figure %.0f: %s\n',figNum, titleString);
figure(figNum); clf;
...
%% fcn_Visibility_plotVGraph - showing selected from/to index
% Plots the visilibity graph for a field of polytopes only showing
% user-selected "from" point and user-selected "to" point

% This is DEMO case 10004 in the test script
figNum = 10003;
titleString = sprintf('fcn_Visibility_plotVGraph - showing selected from/to index');
fprintf(1,'Figure %.0f: %s\n',figNum, titleString);
figure(figNum); clf;
...
%% fcn_Visibility_plotVGraph - showing animated gif
% Plots the visilibity graph for a field of polytopes only showing
% user-selected "from" point and user-selected "to" point

% This is DEMO case 10005 in the test script
figNum = 10004;
titleString = sprintf('fcn_Visibility_plotVGraph - animated');
fprintf(1,'Figure %.0f: %s\n',figNum, titleString);
figure(figNum); clf;
