function [flagsAtLeastOnePointIsInPoly, startPolys, finishPolys, flagsStartIsInPoly, flagsFinishIsInPoly] = ...
    fcn_VGraph_polytopePointsInPolytopes(startXY, finishXY, polytopes, varargin)
% fcn_VGraph_polytopePointsInPolytopes checks if start or finish point(s)
% are within polytopes
%
% FORMAT:
%   
...
% EXAMPLES:
%
%     See the script: script_test_fcn_VGraph_polytopePointsInPolytopes
