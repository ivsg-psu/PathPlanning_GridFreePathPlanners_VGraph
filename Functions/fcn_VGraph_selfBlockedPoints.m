...
%    script_test_fcn_VGraph_selfBlockedPoints
%    See also the implementation of this in the through planner in
...
if flag_do_plots
    ...
    h_polytopes = fcn_MapGen_plotPolytopes(polytopes(currentObstacleID),plotFormat,[1 0 0 1 0.5],(figNum));
